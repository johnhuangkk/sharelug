...
<doc>
    ...
    <BODY>
        ...
        <R28>
            ...
            <ParentId>861</ParentId>
            <EshopId>0001</EshopId>
            <OrderNo>03918823877</OrderNo>
            <EcOrderNo>12345679</EcOrderNo>
            <OrderDate>2020-06-01</OrderDate>
            <OrderTime>141300</OrderTime>
            <OPMode>1</OPMode>
            <StoreId>005989</StoreId>
...
type FMLR28 struct {
	...
	Body   struct {
		Data []FMLR28Data `xml:"R28"`
	} `xml:"BODY"`
	Footer FMLDataFooter `xml:"FOOTER"`
}

type FMLR28Data struct {
...
func (s *FMLR28Data) GetDateTime () string {
	t, _ := time.Parse(`2006-01-02150405`, s.OrderDate + s.OrderTime)
	return t.Format(`2006-01-02 15:04:05`)
}

func (receiver *FMLR28) DecodeXML(data []byte) error {
